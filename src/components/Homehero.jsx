...
const Homehero = () => {
  ...
  <Link to="/">
        ...
        <div className='my-6 mx-7 text-red-600 font-bold text-bold'>
            <Link to="/signup" className='bg-red-500 py-2 px-8 text-white rounded'>Signup</Link>

        </div>

    </header>

    <main  className='flex flex-1 flex-col justify-center items-center text-white sm:px-20'>
        <h1 className='max-w-lg text-3xl'>An limited Movies Tv Show more </h1>
        <h1 className='text-1xl mt-4 mb-3'>Watch any wer cancel anay time</h1>
        <p className='text-lg mb-3'>Ready to watch movies</p>
        <div className='flex mb-3 flex-col space-y-6 sm:flex-row sm:space-y-0'>
            <input type='text' placeholder='email-adrres' className="w-full min-w-[400px] bg-white px-24 py-4 text-black outline-none sm:p-4"/>
              <button className='flex bg-red-400 px-10 itme-center w-full p-4'>Get started</button>
        </div>
    </main>
   </div>
  )
